...
export const DEFAULT_CONFIG = Object.freeze({
  ...
  jianyingCapability: Object.freeze({ unicodeCommitAndExport: false, smokeTestedAt: "" }),
});
...
export function validateConfig(value, { requireCapability = false } = {}) {
  ...
  if (requireCapability && config.jianyingCapability.unicodeCommitAndExport !== true) throw new Error("Jianying capability probe for Unicode text commit/export has not passed");
  return config;
}
